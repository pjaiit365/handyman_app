  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: JobDetailsAndStatus(
        ...
        imageLocation: allJobOffers[selectedJob].pic,
        name: allJobOffers[selectedJob].name,
        region: allJobOffers[selectedJob].region,
        chargeRate: allJobOffers[selectedJob].chargeRate,
        charge: allJobOffers[selectedJob].charge,
        street: allJobOffers[selectedJob].street,
        town: allJobOffers[selectedJob].town,
        houseNum: allJobOffers[selectedJob].houseNum,
        jobType: allJobOffers[selectedJob].serviceProvided,
        date: allJobOffers[selectedJob].uploadDate,
      ),
    );
  }
}
