...
import '../Screens/My Jobs/SubScreens/JobApplied/job_applied_screen.dart';
import '../Screens/My Jobs/SubScreens/JobOffer/job_offer_screen.dart';
import '../Services/read_data.dart';
import '../constants.dart';

class OffersAndAppliedWidget extends StatefulWidget {
  const OffersAndAppliedWidget({Key? key}) : super(key: key);

  @override
  State<OffersAndAppliedWidget> createState() => _OffersAndAppliedWidgetState();
}

class _OffersAndAppliedWidgetState extends State<OffersAndAppliedWidget> {
